  ...
  return (
    <div ref={dropdownRef} className="relative flex flex-col grow gap-1">
      ...
      <button
        ...
        className={`w-full text-left p-3 rounded-md border border-light-border dark:border-dark-border flex justify-between items-center gap-2
        focus:outline-none
...
export default CustomTimeSpanSelect;
