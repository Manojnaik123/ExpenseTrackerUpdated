                ...
                <div className='w-full'>
                    <div className='flex justify-between items-center pt-2'>
                        <span className='text-2xl
                            text-light-primary-text dark:text-dark-primary-text
                            '>{currentCurrencySymbol + ' ' + new Intl.NumberFormat().format((fund ? fund : 0))}
                        </span>
                    ...
                    <div className='flex justify-between items-center
                        ...
                        '>
                        <span>{nav.outOf} {currentCurrencySymbol} {new Intl.NumberFormat().format(amount)}</span>
                    ...
                    <div className='flex justify-between items-center py-1
                        ...
                        '>
                        <span>{date}</span>
                        <span>{Math.round((fund/amount)*100)}%</span>
                    </div>
